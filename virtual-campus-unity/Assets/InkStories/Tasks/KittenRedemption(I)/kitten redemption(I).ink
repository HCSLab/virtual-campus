...
-
*啊，小猫猫听话……
<color=\#808080>（猫咪仍然看着你，仍然不断地叫着）</color>
-
+n
喵……喵！喵！
-
...
*太棒了
#additem: 猫语翻译器
#upd_description: 和宿管阿姨打听过之后，你得到了一个奇怪的设备：猫语翻译器，拿着这个东西就可以和那只叫做小白的猫对话了吗？回到<color=red>乐天一楼食堂</color>门口试试看吧。
->DONE
...
-
+n
她叫<color=blue>小可爱</color>，是只狸花猫，<color=blue>下巴到胸口长着白毛</color>。
-
+n
...
-
*好的
#upd_description: 这只叫小可爱的小母猫怀孕了？！可是她目前还行踪不明啊……只能按照人文学院院长的指示，先回去找<color=red>宿管阿姨</color>问问看了。
->DONE
...
-
+n
这里有一份热心师生为两只猫咪准备的<color=blue>猫粮</color>，或许可以帮助你找到它。
-
+n
...
-
+n 
说不定在喂食的时候，它们会开心地告诉你校园故事。
-
+n 
这些猫粮你可拿好了，份量可不少，应该是很够他们吃一段时间了。
-
#additem: 猫粮
*不过，阿姨你知道小可爱在哪里嘛
小可爱平日总是跟小白一起出现。
...
-
*行，我这就去看看
#upd_description: 宿管阿姨听闻小可爱怀孕，推断她可能是因为出去觅食才长时间不见了的。为了帮助这两只猫，阿姨给了你一些猫粮，拜托你时常去喂食。阿姨推断小可爱现在应该就在食堂附近，因此建议你回去再找<color=red>小白</color>看看。
->DONE
...
*好的
#addskin: 老奶奶
#upd_description: 小可爱竟然真的就在小白旁边……真是奇怪的两只猫。你和小白就猫粮达成了协议，你负责喂食，他负责提供情报。你和猫咪之间的关系也在慢慢的变得亲密起来。
#endstory
->END
