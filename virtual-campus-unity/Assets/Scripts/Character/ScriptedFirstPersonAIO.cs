...
#if UNITY_EDITOR
[CustomEditor(typeof(ScriptedFirstPersonAIO)), InitializeOnLoadAttribute]
public class SFPAIO_Editor : Editor
{
    ScriptedFirstPersonAIO t;
    ...
    void OnEnable()
    {
        t = (ScriptedFirstPersonAIO)target;
    ...
    public override void OnInspectorGUI()
    {
        ...
        t.mouseInputInversion = (ScriptedFirstPersonAIO.InvertMouseInput)EditorGUILayout.EnumPopup(new GUIContent("Mouse Input Inversion", "Determines if mouse input should be inverted, and along which axes"), t.mouseInputInversion);
        ...
        EditorGUILayout.Space();
        t.fsmode = (ScriptedFirstPersonAIO.FSMode)EditorGUILayout.EnumPopup(new GUIContent("Footstep Mode", "Determines the method used to trigger footsetps."), t.fsmode);
        EditorGUILayout.Space();

        #region FS Static
        if (t.fsmode == ScriptedFirstPersonAIO.FSMode.Static)
        {
        ...
        {
            t.dynamicFootstep.materialMode = (ScriptedFirstPersonAIO.DynamicFootStep.matMode)EditorGUILayout.EnumPopup(new GUIContent("Material Type", "Determines the type of material will trigger footstep audio."), t.dynamicFootstep.materialMode);
            EditorGUILayout.Space();
            #region Wood Section
            ...
            {
                GUILayout.BeginVertical("box");
                if (t.dynamicFootstep.materialMode == ScriptedFirstPersonAIO.DynamicFootStep.matMode.physicMaterial)
                {
