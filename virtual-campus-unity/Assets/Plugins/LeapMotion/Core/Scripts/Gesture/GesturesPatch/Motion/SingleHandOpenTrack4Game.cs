...
/// </summary>
public class SingleHandOpenTrack4Game : MonoBehaviour {
    [SerializeField] HandOpen m_HandOpen;
    Controller leap;
    int dirZ, dirX, dirY, rotateQ,rotateE;
    ...
    public string Rotate
    {
        ...
        {
            string dir;
            if (rotateE == 1) dir = "RotateE";
            else if (rotateQ == 1) dir = "RotateQ";
            else dir = "None";
            return dir;
        }
    }
            ...
            if (leap.Frame().Hands.Count == 1)
            {
                ...
                if (number == 1)
                {
                    ...
                    else
                    {
                        ...
                        //Control by position
                        if (curDir.x > 40 && curDir.z < 10 && curDir.z > -10)
                        {
                            dirX = 1;
                            dirY = 0;
                            dirZ = 0;
                        ...
                        else if (curDir.x < -40 && curDir.z < 10 && curDir.z > -10)
                        {
                            dirX = -1;
                            dirY = 0;
                            dirZ = 0;
                        ...
                        else if (curDir.z < -40 && curDir.x < 10 && curDir.x > -10)
                        {
                            dirX = 0;
                            dirY = 0;
                            dirZ = 1;
...
//        m_CurTrackTime = 0f;
        m_CurEnterDelayTime = 0f;
        dirX = dirZ = dirY = rotateE = rotateQ =0;
    }
}
